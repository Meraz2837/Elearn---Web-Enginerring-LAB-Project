...
<body class="bg-light">
    ...
    <div class="mx-auto text-center my-5">
        <a href="onlineclass.php" class="btn btn-danger px-5 py-3">Class Video</a>
    </div>


    <div class="mx-auto text-center my-5">
        <a href="contents/books/Mobile_Photography_Sadman_Sadik.pdf" class="btn btn-primary">Download Book!</a>
    </div>



    <div class="mx-auto text-center my-5">
        <a href="certificate.php" class="btn btn-warning">Get your Certificate</a>
    </div>

    <div class="mx-auto text-center my-5">
        <a href="result.php" class="btn btn-dark p-4">Get your Result</a>
    </div>
