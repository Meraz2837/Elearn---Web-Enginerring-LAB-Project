...
<body>
    ...
    <div class="mx-auto text-center">
        <img class="img-fluid" src="Admin/certificate/certificates/<?php echo htmlspecialchars($_SESSION["phone"]); ?>.png">
    </div>

    <div class="text-center my-5">
        <a download="Certificate" class="btn btn-warning button" href="Admin/certificate/certificates/<?php echo htmlspecialchars($_SESSION["phone"]); ?>.png">Download your Certificate</a>
    </div>
