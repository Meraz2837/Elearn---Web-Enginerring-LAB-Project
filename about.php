...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <div class="navbar-nav">
                        ...
                        <a class="nav-link text-danger" href="certificate">About</a>
                    </div>
    ...
    <section>
        <h1 class="text-center"><b>Meaningless Compiler Team</b></h1>
    </section>
    ...
    <section class=" container">
        ...
        <div class="row">
            <div class="col-md-6 my-auto mx-auto">
                <h3 class="text-center"><b>Md. Mazbaur Rashid</b></h3>
            ...
            <div class="col-md-6">
                <img class="img-fluid" src="Team/1.png" alt="elearn">
            </div>
        </div>
        <hr>
    </section>
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <img class="img-fluid" src="Team/3.png" alt="elearn">
            </div>
            <div class="col-md-6 my-auto mx-auto">
                <h3 class="text-center"><b>Md. Sabbir Alam</b></h3>
                <hr style="height: 5px; width: 30px;" class="text-dark text-center mx-auto">
                <h5 class="text-center">
                    192-15-2847
                </h5>
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-md-6 my-auto mx-auto">
                <h3 class="text-center"><b>Shariar Kabir Nayeem</b></h3>
                <hr style="height: 5px; width: 30px;" class="text-dark text-center mx-auto">
                <h5 class="text-center">
                    192-15-2854
                </h5>
            ...
            <div class="col-md-6">
                <img class="img-fluid" src="Team/2.png" alt="elearn">
            </div>
        </div>
        <hr>
    </section>
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-md-6">
                <img class="img-fluid" src="Team/4.png" alt="elearn">
            </div>
            <div class="col-md-6 my-auto mx-auto">
                <h3 class="text-center"><b>Nazmus Sakib Tanim</b></h3>
                <hr style="height: 5px; width: 30px;" class="text-dark text-center mx-auto">
                <h5 class="text-center">
                    192-15-2855
                </h5>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 mx-auto my-auto text-sm-center">
                    <h4 class="text-danger mt-2 text-center"><b>Meaningless Compiler</b></h4>
                </div>
